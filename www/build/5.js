...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__acceptdetail__ = __webpack_require__(737);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_pipes_module__ = __webpack_require__(387);
...
var AcceptdetailPage = /** @class */ (function () {
    function AcceptdetailPage(navCtrl, navParams, http, httpClient, loadingCtrl, toastCtrl, view, modalCtrl) {
    ...
    AcceptdetailPage.prototype.chat = function () {
        var myModalOptions = {
            enableBackdropDismiss: false
        };
        var myModal = this.modalCtrl.create('ChatPage', { data: this.data.recommand }, myModalOptions);
        myModal.present();
